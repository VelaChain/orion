...
type PoolAsset struct {
	...
	// skd.Uint amout of pool asset
	Amount github_com_cosmos_cosmos_sdk_types.Uint `protobuf:"bytes,2,opt,name=amount,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Uint" json:"amount" yaml:"asset_amount"`
}
...
type PoolShares struct {
	...
	// amount of shares
	Amount github_com_cosmos_cosmos_sdk_types.Uint `protobuf:"bytes,2,opt,name=amount,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Uint" json:"amount" yaml:"PoolShares_amount"`
}
...
type Pool struct {
	...
	SwapFee github_com_cosmos_cosmos_sdk_types.Uint `protobuf:"bytes,6,opt,name=swapFee,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Uint" json:"swapFee" yaml:"Pool_swapFee"`
	// fee to exit the pool
	// TODO determine how fee is paid - could burn % before
	// exchanging shares for assets
	ExitFee github_com_cosmos_cosmos_sdk_types.Uint `protobuf:"bytes,7,opt,name=exitFee,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Uint" json:"exitFee" yaml:"Pool_exitFee"`
}
...
var fileDescriptor_b49c02541056d449 = []byte{
	...
	,
}
