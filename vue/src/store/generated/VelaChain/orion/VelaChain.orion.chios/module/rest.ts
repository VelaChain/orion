 ...
 */
export interface ChiosQueryParamsResponse {
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @request GET:/VelaChain/orion/chios/params
   */
  queryParams = (params: RequestParams = {}) =>
    this.request<ChiosQueryParamsResponse, RpcStatus>({
      path: `/VelaChain/orion/chios/params`,
      method: "GET",
      format: "json",
      ...params,
    });
